...
var periods__$1 = cljs.core.vec((function (){var G__71798 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71795_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__71795_SHARP_,(0),(3));
}),G__71798);
} else {
return G__71798;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__71827){
var vec__71831 = p__71827;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71831,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71831,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__71834 = pattern;
switch (G__71834) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71834)].join('')));
...
switch (G__71845__$1) {
case "millis":
return (function (p1__71836_SHARP_){
return p1__71836_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__71837_SHARP_){
return p1__71837_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__71838_SHARP_){
return p1__71838_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__71840_SHARP_){
return p1__71840_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__71841_SHARP_){
return p1__71841_SHARP_.getHours();
});

break;
case "day":
return (function (p1__71842_SHARP_){
return p1__71842_SHARP_.getDate();
});

break;
case "month":
return (function (p1__71843_SHARP_){
return p1__71843_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__71844_SHARP_){
return p1__71844_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71845__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__71851){
var vec__71853 = p__71851;
var seq__71854 = cljs.core.seq(vec__71853);
var first__71855 = cljs.core.first(seq__71854);
var seq__71854__$1 = cljs.core.next(seq__71854);
var key = first__71855;
var args = seq__71854__$1;
var G__71860 = key;
...
break;
case "ordinal-suffix":
var vec__71871 = (function (){var G__71874 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__71874) : syntax_list.call(null,G__71874));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71871,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71860__$1)].join('')));
...
var d = value;
var G__71903 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__71904 = G__71903;
var seq__71905 = cljs.core.seq(vec__71904);
var first__71906 = cljs.core.first(seq__71905);
var seq__71905__$1 = cljs.core.next(seq__71905);
var unparser = first__71906;
var more = seq__71905__$1;
var s = "";
var d__$1 = d;
var G__71903__$1 = G__71903;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__71921 = G__71903__$1;
var seq__71922 = cljs.core.seq(vec__71921);
var first__71923 = cljs.core.first(seq__71922);
var seq__71922__$1 = cljs.core.next(seq__71922);
var unparser__$1 = first__71923;
var more__$1 = seq__71922__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__71924 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71924,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71924,(1),null);
var G__71980 = d__$3;
var G__71981 = more__$1;
var G__71982 = s__$3;
d__$1 = G__71980;
G__71903__$1 = G__71981;
s__$1 = G__71982;
continue;
}
break;
