...
return (function (p__72576){
var map__72577 = p__72576;
var map__72577__$1 = cljs.core.__destructure_map(map__72577);
var props = map__72577__$1;
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72577__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
...
var len__5766__auto___72613 = arguments.length;
var i__5767__auto___72614 = (0);
while(true){
if((i__5767__auto___72614 < len__5766__auto___72613)){
args__5772__auto__.push((arguments[i__5767__auto___72614]));

var G__72616 = (i__5767__auto___72614 + (1));
i__5767__auto___72614 = G__72616;
continue;
} else {
}
break;
...
return re_com.error_modal.error_modal.cljs$core$IFn$_invoke$arity$variadic(argseq__5773__auto__);
});

(re_com.error_modal.error_modal.cljs$core$IFn$_invoke$arity$variadic = (function (p__72590){
var map__72591 = p__72590;
var map__72591__$1 = cljs.core.__destructure_map(map__72591);
var args = map__72591__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),true);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var pre_theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"pre-theme","pre-theme",-1454266181));
var engineers_notified_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"engineers-notified?","engineers-notified?",1421448285),true);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var bug_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"bug?","bug?",1202760128),true);
var implications_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"implications-title","implications-title",-936575167),"Implications");
var undone_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"undone?","undone?",-1342458015));
var implications = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"implications","implications",-1275270911));
var what_to_do = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"what-to-do","what-to-do",-1372507613));
var triangle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"triangle","triangle",-1828376667));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var inner_wrapper = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"inner-wrapper","inner-wrapper",1366997544));
var proceedable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"proceedable?","proceedable?",1701539112));
var instructions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"instructions","instructions",1724333802));
var ask_to_report_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"ask-to-report?","ask-to-report?",-870526709));
var what_to_do_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"what-to-do-title","what-to-do-title",1255991148),"What Should You Do Now?");
var what_happened = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"what-happened","what-happened",1302018349));
var header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"header","header",119441134));
var modal = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"modal","modal",-1031880850));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"title","title",636505583),"Sorry, you've hit a bug");
var details_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"details-title","details-title",634180784),"Low-level Details (for developers):");
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var top_bar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"top-bar","top-bar",-1709393391));
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"details","details",1956795411));
var what_happened_title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"what-happened-title","what-happened-title",-1667989325),"What Just Happened?");
var defaults_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"defaults?","defaults?",-972070733),true);
var backdrop_on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"backdrop-on-click","backdrop-on-click",-1460240426));
var severity = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__72591__$1,new cljs.core.Keyword(null,"severity","severity",175684886),new cljs.core.Keyword(null,"error","error",-978969032));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var title_wrapper = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"title-wrapper","title-wrapper",-118118185));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72591__$1,new cljs.core.Keyword(null,"action","action",-811238024));
var theme__$1 = re_com.theme.comp(pre_theme,theme);
var part = (function() { 
var G__72627__delegate = function (part_value,p__72596){
var map__72597 = p__72596;
var map__72597__$1 = cljs.core.__destructure_map(map__72597);
var opts = map__72597__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72597__$1,new cljs.core.Keyword(null,"props","props",453281727));
...
var G__72627 = function (part_value,var_args){
var p__72596 = null;
if (arguments.length > 1) {
var G__72628__i = 0, G__72628__a = new Array(arguments.length -  1);
while (G__72628__i < G__72628__a.length) {G__72628__a[G__72628__i] = arguments[G__72628__i + 1]; ++G__72628__i;}
  p__72596 = new cljs.core.IndexedSeq(G__72628__a,0,null);
} 
return G__72627__delegate.call(this,part_value,p__72596);};
G__72627.cljs$lang$maxFixedArity = 1;
G__72627.cljs$lang$applyTo = (function (arglist__72629){
var part_value = cljs.core.first(arglist__72629);
var p__72596 = cljs.core.rest(arglist__72629);
return G__72627__delegate(part_value,p__72596);
});
G__72627.cljs$core$IFn$_invoke$arity$variadic = G__72627__delegate;
return G__72627;
})()
;
...
var what_happened__$1 = (function (){var or__5043__auto__ = what_happened;
...
var implications__$1 = (function (){var or__5043__auto__ = implications;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
if(cljs.core.truth_(defaults_QMARK_)){
...
var what_to_do__$1 = (function (){var or__5043__auto__ = what_to_do;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
if(cljs.core.truth_(defaults_QMARK_)){
...
/** @this {Function} */
(re_com.error_modal.error_modal.cljs$lang$applyTo = (function (seq72584){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq72584));
}));
