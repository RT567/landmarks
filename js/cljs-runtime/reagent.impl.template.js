...
var G__68100 = o;
reagent.impl.template.goog$module$goog$object.set(G__68100,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__68424__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__68424 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__68425__i = 0, G__68425__a = new Array(arguments.length -  0);
while (G__68425__i < G__68425__a.length) {G__68425__a[G__68425__i] = arguments[G__68425__i + 0]; ++G__68425__i;}
  args = new cljs.core.IndexedSeq(G__68425__a,0,null);
} 
return G__68424__delegate.call(this,args);};
G__68424.cljs$lang$maxFixedArity = 0;
G__68424.cljs$lang$applyTo = (function (arglist__68426){
var args = cljs.core.seq(arglist__68426);
return G__68424__delegate(args);
});
G__68424.cljs$core$IFn$_invoke$arity$variadic = G__68424__delegate;
return G__68424;
})()
;
} else {
...
var G__68122 = o;
reagent.impl.template.goog$module$goog$object.set(G__68122,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__68432__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__68432 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__68433__i = 0, G__68433__a = new Array(arguments.length -  0);
while (G__68433__i < G__68433__a.length) {G__68433__a[G__68433__i] = arguments[G__68433__i + 0]; ++G__68433__i;}
  args = new cljs.core.IndexedSeq(G__68433__a,0,null);
} 
return G__68432__delegate.call(this,args);};
G__68432.cljs$lang$maxFixedArity = 0;
G__68432.cljs$lang$applyTo = (function (arglist__68434){
var args = cljs.core.seq(arglist__68434);
return G__68432__delegate(args);
});
G__68432.cljs$core$IFn$_invoke$arity$variadic = G__68432__delegate;
return G__68432;
})()
;
} else {
...
var G__68136 = props;
var G__68136__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68136,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__68136);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68136__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__68154 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68154,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__68154;
}
})(),id_class);
...
var G__68168 = (cljs.core.count(argv) - first_child);
switch (G__68168) {
case (0):
...
var vec__68198 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68198,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68198,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68198,(2),null);
...
var temp__5808__auto___68459 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___68459 == null)){
} else {
var key_68461 = temp__5808__auto___68459;
(jsprops.key = key_68461);
}
...
var temp__5808__auto___68465 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___68465 == null)){
} else {
var key_68466 = temp__5808__auto___68465;
(jsprops.key = key_68466);
}
...
var temp__5808__auto___68471 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___68471 == null)){
} else {
var key_68474 = temp__5808__auto___68471;
(jsprops.key = key_68474);
}
...
var temp__5808__auto___68492 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___68492 == null)){
} else {
var key_68495 = temp__5808__auto___68492;
(jsprops.key = key_68495);
}
...
var temp__5808__auto___68499 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___68499 == null)){
} else {
var key_68504 = temp__5808__auto___68499;
(jsprops.key = key_68504);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68289_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__68289_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__68319 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68319,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68319,(1),null);
...
break;
default:
var G__68522 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__68523 = compiler;
v = G__68522;
compiler = G__68523;
continue;
...
var G__68345 = tag;
var G__68345__$1 = (((G__68345 instanceof cljs.core.Keyword))?G__68345.fqn:null);
switch (G__68345__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template68372 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template68372 = (function (opts,id,fn_to_element,parse_fn,meta68373){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta68373 = meta68373;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template68372.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_68374,meta68373__$1){
var self__ = this;
var _68374__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template68372(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta68373__$1));
}));

(reagent.impl.template.t_reagent$impl$template68372.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_68374){
var self__ = this;
var _68374__$1 = this;
return self__.meta68373;
}));

(reagent.impl.template.t_reagent$impl$template68372.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template68372.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template68372.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template68372.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template68372.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template68372.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta68373","meta68373",1227244470,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template68372.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template68372.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template68372");

(reagent.impl.template.t_reagent$impl$template68372.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template68372");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template68372.
 */
reagent.impl.template.__GT_t_reagent$impl$template68372 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template68372(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta68373){
return (new reagent.impl.template.t_reagent$impl$template68372(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta68373));
});

}

return (new reagent.impl.template.t_reagent$impl$template68372(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
