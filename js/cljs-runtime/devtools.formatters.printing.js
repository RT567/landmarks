...
var len__5766__auto___60064 = arguments.length;
var i__5767__auto___60065 = (0);
while(true){
if((i__5767__auto___60065 < len__5766__auto___60064)){
args__5772__auto__.push((arguments[i__5767__auto___60065]));

var G__60069 = (i__5767__auto___60065 + (1));
i__5767__auto___60065 = G__60069;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq59989){
var G__59990 = cljs.core.first(seq59989);
var seq59989__$1 = cljs.core.next(seq59989);
var G__59991 = cljs.core.first(seq59989__$1);
var seq59989__$2 = cljs.core.next(seq59989__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59990,G__59991,seq59989__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60019_SHARP_){
return (!((cljs.core.meta(p1__60019_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60047__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60048){var _e__58867__auto__ = e60048;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e60051){var _e__58867__auto__ = e60051;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__60057 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__60058 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__60058);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60059__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__60057);
}});
...
var temp__5802__auto___60089 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___60089)){
var managed_print_level_60091 = temp__5802__auto___60089;
var _STAR_print_level_STAR__orig_val__60061_60092 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__60062_60093 = managed_print_level_60091;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__60062_60093);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__60060_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__60060_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__60061_60092);
}} else {
job_fn();
}
